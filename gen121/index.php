...
<div class="container-fluid">
  <header>
  	<div class="row sm-flex p-1 text-white"  style="background-color: #3A506B;color: white;">
    <h4 class="display-4 mb-4 text-center">July 2019</h4>
    <marquee scrollamount="10">:. This time to register every one .:||:. King Mongkut’s University of Technology Thonburi :: KMUTT .:</marquee>
 	</div>
    <div class="row d-none d-sm-flex p-1 bg-dark text-white">
      <h5 class="col-sm p-1 text-center" style="background-color: red">Sunday</h5>
  ...
  <div class="row border border-right-0 border-bottom-0">
    ...
    <div class="day col-sm p-2 border border-left-0 border-top-0 text-truncate ">
      ...
      <a class="event d-block p-1 pl-2 pr-2 mb-1 rounded text-truncate small bg-primary text-white" title="ลงทะเบียนเรียนรวม" style="font-size: 16px;">ลงทะเบียนเรียนรวม</a>
    </div>
    <div class="day col-sm p-2 border border-left-0 border-top-0 text-truncate ">
      <h5 class="row align-items-center">
    ...
    <div class="day col-sm p-2 border border-left-0 border-top-0 text-truncate ">
      ...
      <a class="event d-block p-1 pl-2 pr-2 mb-1 rounded text-truncate small bg-dark text-white" title="ลงทะเบียนชั้นปีที่4-5" style="font-size: 16px;">ลงทะเบียนชั้นปีที่4-5</a>
    </div>
    <div class="day col-sm p-2 border border-left-0 border-top-0 text-truncate ">
      <h5 class="row align-items-center">
    ...
    <div class="day col-sm p-2 border border-left-0 border-top-0 text-truncate ">
      ...
      <a class="event d-block p-1 pl-2 pr-2 mb-1 rounded text-truncate small bg-success text-white" title="ลงทะเบียนชั้นปีที่3" style="font-size: 16px;">ลงทะเบียนชั้นปีที่3</a>
    </div>
    <div class="day col-sm p-2 border border-left-0 border-top-0 text-truncate ">
      <h5 class="row align-items-center">
    ...
    <div class="day col-sm p-2 border border-left-0 border-top-0 text-truncate ">
      ...
      <a class="event d-block p-1 pl-2 pr-2 mb-1 rounded text-truncate small bg-info text-white" title="ลงทะเบียนชั้นปีที่2" style="font-size: 16px;">ลงทะเบียนชั้นปีที่2</a>
    </div>
    <div class="day col-sm p-2 border border-left-0 border-top-0 text-truncate ">
      <h5 class="row align-items-center">
    ...
    <div class="day col-sm p-2 border border-left-0 border-top-0 text-truncate ">
      ...
      <a class="event d-block p-1 pl-2 pr-2 mb-1 rounded text-truncate small bg-danger text-white" title="ลงทะเบียนชั้นปีที่1" style="font-size: 16px;">ลงทะเบียนชั้นปีที่1</a>
    </div>
    <div class="day col-sm p-2 border border-left-0 border-top-0 text-truncate ">
      <h5 class="row align-items-center">
